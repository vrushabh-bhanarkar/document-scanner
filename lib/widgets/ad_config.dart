...
class AdConfig {
  ...
  //     'ca-app-pub-6586073221878389/3484062745'; // Production ad unit
  static String interstitialAdUnitId =
      'ca-app-pub-3940256099942544/1033173712'; // TEST ad unit

  // Banner Ad Unit ID
  // static String bannerAdUnitId =
  //     'ca-app-pub-6586073221878389/7339693065'; // Production ad unit
  static String bannerAdUnitId =
  ...
  //     'ca-app-pub-6586073221878389/1324517855'; // Production native ad unit
  static const String nativeAdUnitId =
